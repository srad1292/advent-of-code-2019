const ReactionChemical = require("../solvers/day-14");
...
function solvePartOne() {
    ...
    input = getTestInputOne();
    cost = ReactionChemical.solvePartOne(input);
    console.log("Test 1 Cost for fuel should be 31.  Is: " + cost);

    input = getTestInputTwo();
    cost = ReactionChemical.solvePartOne(input);
    console.log("Test 2 Cost for fuel should be 165.  Is: " + cost);

    input = getTestInputThree();
    cost = ReactionChemical.solvePartOne(input);
    console.log("Test 3 Cost for fuel should be 13312.  Is: " + cost);

    input = getTestInputFour();
    cost = ReactionChemical.solvePartOne(input);
    console.log("Test 4 Cost for fuel should be 180697.  Is: " + cost);

    input = getTestInputFive();
    cost = ReactionChemical.solvePartOne(input);
    console.log("Test 5 Cost for fuel should be 2210736.  Is: " + cost);

    input = getActualInputPartOne();
    cost = ReactionChemical.solvePartOne(input);
    console.log("Part One should be 399063.  Is: " + cost);
}
...
// 399063
function getActualInputPartOne() {
    return `180 ORE => 9 DQFL
